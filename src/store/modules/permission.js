 import {asyncRouterMap, constantRouterMap, createRouter} from '@/router/index'
...
const permission = {
  ...
  actions: {
    ...
    InitRoutes({commit}, routeList) {
      // let list = createRouter(routeList)
      return new Promise(resolve => {
        let accessedRouters = routeList
        commit('SET_ROUTERS', accessedRouters)
        resolve()
      })
    }
