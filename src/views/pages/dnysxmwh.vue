	...
	export default {
		...
		methods: {
			inputchange(item) {
				...
				sum.plus1 = Number(sum.zjybggys || 0) + Number(sum.zjzfjjys || 0) + Number(sum.zjgyzbjyys || 0)+Number(sum.zjqt || 0)			
